...
class CategoriesProduct extends Controller
{
    ...
    public function show_category_home($category_id) {
        ...
        return view('pages.categories.show_category')->with('category', $cate_product)->with('category_by_id', $category_by_id)->with('category_name', $category_name)->with('category_post', $cate_post)->with('partner', $partner)->with('list_product', $list_product);
    }
}
