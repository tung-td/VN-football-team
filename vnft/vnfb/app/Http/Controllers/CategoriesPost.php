...
class CategoriesPost extends Controller
{
    ...
    public function show_category_home($category_id) {
        ...
        $all_post = DB::table('tbl_post')->where('post_status',1)->where('cate_post_id', $category_id)->orderBy('created_at', 'desc')->get();
        $hot_post = DB::table('tbl_post')->where('post_status',1)->where('cate_post_id', $category_id)->orderBy('post_view', 'desc')->first();
    ...
    public function news() {
        ...
        $hot_post = DB::table('tbl_post')->where('post_status',1)->orderBy('post_view', 'desc')->first();

        return view('pages.posts.news')->with([
            'category' => $cate_product,
            'category_post'=> $cate_post,
            'all_post' => $all_post,
            'hot_post' => $hot_post,
