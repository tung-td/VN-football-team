                        ...
                        <div class="product-grid">
                            ...
                            <div class="product-image">
                                ...
                                <ul class="product-links">
                                    <li><button onclick="showSuccessCartToast('add_to_cart','{{$product->product_name}}',1,'{{URL('/cart')}}')" type="button" class="buy-product form-control btn add-to-cart" data-id_product="{{$product->product_id}}" name="add-to-cart" style="border-radius: 50px;;">
