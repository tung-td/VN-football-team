    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-4">
                <a href="./product_detail.html">
                    <img src="../../assests/img/Shop_VN/home_1.jpg" class="rounded img-thumbnail" alt="...">
                    <p>VIETNAM Home Shirt 2021-22</p>
                </a>
        ...
        <div class="row align-items-end">
            <div class="coupon-form">
                ...
                <button class="col-1 cs-1 ip">
                    Apply Coupon
                </button>
            </div>
            <div class="subtotal">Subtotal: $67.00</div>
        </div>
        <hr>
        <div class="row submit-button">
            <div class="col-5 hd-5">
                ...
                <a href="{{url('/')}}" class="col-1 cs-1" id="back-shop">
                    <i class="ti-arrow-circle-left bc-1"></i> Back to Shopping
                </a>
                @endif
            </div>
            <div class="col-2 cs-2">
                <div class="col-1 hd-1">
                    <button class="col-1 cs-1" id="update-cart">
                        Update Cart
                        <i class="ti-reload bc-2"></i>
                    </button>
                </div>
                <div class="col-1 hd-1">
                    <a class="col-1 cs-1" id="checkout-cart" href="../thanks/thanks.html">
                        Checkout
